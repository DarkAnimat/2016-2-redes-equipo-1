...
#filename = "testing.wav"                          # Original signal
#filename = "recorded_testing.wav"                   # Recorded signal with background noise only
#filename = "recorded_testing_with_noise.wav"        # Recorded signal with music at 50% volume
filename = "recorded_testing_with_more_noise.wav"   # Recorded signal with music at 100% volume
#filename = "recorded_testing_with_more_noise_2.wav"
#filename = "recorded_testing_sudden_noise.wav"      # Recorded signal with sudden coin noises.
